...
namespace Amazon.Extensions.Configuration.SystemsManager
{
    ...
    /// </summary>
    public class HackSystemsManagerConfigurationSource : ISystemsManagerConfigurationSource
    {
        public HackSystemsManagerConfigurationSource()
        {
        ...
        {
            return new HackSystemsManagerConfigurationProvider(this);
        }
    }
}

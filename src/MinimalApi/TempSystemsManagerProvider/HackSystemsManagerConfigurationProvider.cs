...
namespace Amazon.Extensions.Configuration.SystemsManager
{
    ...
    /// </summary>
    public class HackSystemsManagerConfigurationProvider : ConfigurationProvider
    {
        ...
        public HackSystemsManagerConfigurationProvider(HackSystemsManagerConfigurationSource source) : this(source, new HackSystemsManagerProcessor(source))
        {
        }
        ...
        public HackSystemsManagerConfigurationProvider(AppConfigConfigurationSource source) : this(source, new AppConfigProcessor(source))
        {
        }
        ...
        public HackSystemsManagerConfigurationProvider(ISystemsManagerConfigurationSource source, ISystemsManagerProcessor systemsManagerProcessor)
        {

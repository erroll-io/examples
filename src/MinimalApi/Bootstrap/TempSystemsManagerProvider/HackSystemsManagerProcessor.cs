...
namespace Amazon.Extensions.Configuration.SystemsManager.Internal
{
    ...
    public class HackSystemsManagerProcessor : ISystemsManagerProcessor
    {
        ...
        private HackSystemsManagerConfigurationSource Source { get; }

        public HackSystemsManagerProcessor(HackSystemsManagerConfigurationSource source)
        {
